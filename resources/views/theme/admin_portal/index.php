...
<body>
            ...
            <li class="menu-item <?php echo request()->is('employees*', 'designations', 'attendances', 'holidays', 'leaves') ? 'active open' : ''; ?>">
              ...
              <ul class="menu-sub">
                ...
                <?php if (checkPermission($userRolePermissions, 'leave_request_module')) { ?>
                  <li class="menu-item <?php echo request()->is('leave_request_module') ? 'active' : ''; ?>">
  ...
  <script src="<?php echo asset('/theme/assets/vendor/libs/jquery/jquery.js'); ?>"></script>
  <script src="<?php echo asset('/theme/assets/vendor/libs/popper/popper.js'); ?>"></script>
  <script src="<?php echo asset('/theme/assets/vendor/js/bootstrap.js'); ?>"></script>
  <script src="<?php echo asset('/theme/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js'); ?>"></script>

  <script src="<?php echo asset('/theme/assets/vendor/js/menu.js'); ?>"></script>
  <!-- endbuild -->

  <!-- Vendors JS -->
  <script src="<?php echo asset('/theme/assets/vendor/libs/apex-charts/apexcharts.js'); ?>"></script>

  <!-- Main JS -->
  <script src="<?php echo asset('/theme/assets/js/main.js'); ?>"></script>

  <!-- Page JS -->
  <script src="<?php echo asset('/theme/assets/js/dashboards-analytics.js'); ?>"></script>

  <script src="<?php echo asset('/theme/assets/vendor/jquery.datetimepicker.full.min.js'); ?>"></script>
