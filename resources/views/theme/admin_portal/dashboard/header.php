...
<html
  ...
  data-assets-path=""<?php echo asset('theme/assets/'); ?>"
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- doctors -->
            <li class="menu-item <?php echo request()->is('doctors') ? 'active' : ''; ?>">
              <a href="<?php echo url('doctors'); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
            ...
            <!-- doctors Schedule -->
            <li class="menu-item <?php echo request()->is('doctor-schedules') ? 'active' : ''; ?>">
              <a href="<?php echo url('doctor-schedules'); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Doctor Schedule</div>
              </a>
            </li>

            <!-- Patient Appinment -->
            <li class="menu-item <?php echo request()->is('patient-appoinments') ? 'active' : ''; ?>">
              <a href="<?php echo url('patient-appoinments'); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Patient Appinment</div>
              </a>
            </li>

            <!-- Patient Case Studies -->
            <li class="menu-item <?php echo request()->is('patient-case-studies') ? 'active' : ''; ?>">
              <a href="<?php echo url('patient-case-studies'); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Patient Case Studies</div>
              </a>
            </li>
