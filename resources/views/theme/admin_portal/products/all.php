...
<div class="card shadow-sm">
    <div class="card-header border-bottom d-flex align-items-center justify-content-between">
        ...
        <div class="card-toolbar">
            <button type="button" class="btn btn-primary btn-md me-3 fs-6" data-bs-toggle="modal" data-bs-target=".add_product_modal">
                Add Product
            </button>
        </div>
    </div>
    <div class="card-body py-4">
        <div class="table-responsive">
            <table class="table align-items-center mb-0" id="dt_products">
                <thead>
...
<?php include(resource_path('/views/theme/admin_portal/products/template/add_product_modal.php')); ?>

<script>
    $(document).ready(function() {
        var url = "<?php echo url('products/server-side-data'); ?>";
