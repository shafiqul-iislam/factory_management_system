...
<div class="card shadow-sm">
    <div class="card-header border-bottom d-flex align-items-center justify-content-between">
        ...
        <div class="card-toolbar">
            <button type="button" class="btn btn-primary btn-md me-3 fs-6" data-bs-toggle="modal" data-bs-target=".add_holiday_modal">
                Add Holiday
            </button>
        </div>
    </div>
    <div class="card-body py-4">
        <div class="table-responsive">
            <table class="table align-items-center mb-0" id="dt_holidays">
                <thead>
                    <tr class="text-start fs-6">
                        <th class="font-weight-bolder" style="min-width: 40px;">ID</th>
                        <th class="font-weight-bolder" style="min-width: 200px;">Holiday</th>
                        ...
                        <th class="font-weight-bolder" style="min-width: 150px;">Length</th>
                        <th class="font-weight-bolder" style="min-width: 150px;">Status</th>
                        <th class="font-weight-bolder" style="min-width: 150px;">Created At</th>
...
<?php include(resource_path('/views/theme/admin_portal/hrm/holidays/template/add_holiday_modal.php')) ?>

<script>
    $(document).ready(function() {
        var url = "<?php echo url('holidays/server-side-data'); ?>";

        var table = $('#dt_holidays').DataTable({
            serverSide: true,
            processing: true,
            orderable: false,
            scrollX: true,
