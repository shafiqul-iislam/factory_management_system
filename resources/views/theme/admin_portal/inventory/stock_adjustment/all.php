...
<div class="card shadow-sm">
    <div class="card-header border-bottom d-flex align-items-center justify-content-between">
        ...
        <div class="card-toolbar">
            <button type="button" class="btn btn-primary btn-md me-3 fs-6" data-bs-toggle="modal" data-bs-target=".add_new_stock_modal">
                New Stock
            </button>
        </div>
    </div>
    <div class="card-body py-4">
        <div class="table-responsive">
            <table class="table align-items-center mb-0" id="dt_stocks">
                <thead>
...
<?php include(resource_path('/views/theme/admin_portal/inventory/stock_adjustment/template/stock_adjustment_modal.php')); ?>

<script>
    $(document).ready(function() {
        var url = "<?php echo url('stocks/server-side-data'); ?>";

        var table = $('#dt_stocks').DataTable({
            serverSide: true,
            processing: true,
            orderable: false,
            scrollX: true,
