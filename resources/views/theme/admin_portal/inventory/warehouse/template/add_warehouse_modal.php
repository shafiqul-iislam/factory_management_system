<form action="<?php echo url('warehouses/add'); ?>" method="post" enctype="">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-uppercase" id="exampleModalLabel">Add Warehouse</h5>
                    ...
                    <div class="row d-flex justify-content-center mb-3">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control form-control-solid" placeholder="Enter Warehouse Name" required>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
